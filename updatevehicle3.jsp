...
<%
    ...
    String value1=request.getParameter("chassis_no");
    String value2=request.getParameter("reg_no");
    Statement st2 = con1.createStatement();
    int i = st2.executeUpdate("update vehicle1 set reg_no= '"+value2+"' where chassis_no='"+value1+"'");
