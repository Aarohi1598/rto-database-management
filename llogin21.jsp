     ...
     Class.forName("com.mysql.jdbc.Driver");  
       ...
       PreparedStatement ps = con.prepareStatement("insert into app1 values(?,?,?,?,?)");
        ...
        ps.setString(5, gender);
         ...
         /*PreparedStatement ps1 = con.prepareStatement("insert into test (adhar_no) values (?)");
        
        ps1.setString(1, adhar_no);
        ps1.executeUpdate();  */  
         
       //out.println(rsselect);
        out.println(" application registered successfully");
