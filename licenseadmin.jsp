<%-- 
application of license by admin
--%>
<html>
<title>RTO</title>
<meta charset="UTF-8">
...
<%
    ...
    String lic_id = request.getParameter("lic_id");
    ...
    try {
     Class.forName("com.mysql.jdbc.Driver");  
       ...
       PreparedStatement ps1 = con.prepareStatement("insert into lic2 values(?,?)");
       
        ps1.setString(1, adhar_no);

        ps1.setString(2, lic_id);
