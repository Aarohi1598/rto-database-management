<%--
details of challan for user result
--%>
...
<html>
    ...
    <center><h4>SEARCH RESULT</h4></center>
        ...
        String value=request.getParameter("reg_no");
        ...
        if(value==""){
            ...
            rsselect = st2.executeQuery("select * from fine1 where reg_no='"+value+"'");
    ...
    <tr>   
        ...
        <td><%= rsselect.getString("reg_no") %> </td><br>
