<%-- 
deleting record by admin when fail
--%>
<html>
<title>RTO</title>
<meta charset="UTF-8">
...
<%
    ...
    try {
     Class.forName("com.mysql.jdbc.Driver");  
        ...
        PreparedStatement ps = con.prepareStatement("DELETE t, a FROM test AS t JOIN app1 AS a ON t.adhar_no = a.adhar_no WHERE t.adhar_no = '"+value+"' ;");
